    ...
    <div class="flex items-center gap-2">
        ...
        <div class="relative">
            ...
            <div id="dash-user-menu" class="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50 hidden">
                ...
                <a href="{{ route('logout', [], false) }}" class="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50">Déconnexion</a>
            </div>
        </div>
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="p-4 border-t border-gray-200 bg-white">
            ...
            <div id="sidebar-user-menu" class="mt-2 hidden">
                ...
                @endif
                <a href="{{ route('logout', [], false) }}" class="mt-2 w-full flex items-center justify-center px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 hover:text-red-700 rounded-md transition-colors border border-red-200">
                    Déconnexion
                </a>
            </div>
        </div>
