...
@section('content')
    <div class="container mx-auto px-4 py-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg animate-fade-in-up delay-400">
                            ...
                            <div class="flex items-center text-gray-600">
                                ...
                                {{ $feed->feedable->location ?? '—' }}@if($feed->feedable->place) ({{ $feed->feedable->place }} places)@endif
                            </div>
                        </div>
                    </div>
        ...
        @elseif($feed->feedable_type === 'App\Models\Event')
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-purple-600 animate-fade-in-up">
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 animate-fade-in-up delay-300">
                        ...
                        @if(!empty($feed->feedable->location))
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h3 class="font-medium text-gray-700 mb-2">Lieu</h3>
                            <div class="flex items-center text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-8 p-4 rounded-xl border border-gray-200 bg-gray-50">
            @include('partials.social-share', ['url' => url()->current(), 'title' => $feed->feedable->title . ' - DigitPosts', 'variant' => 'light'])
        </div>
    </div>
