        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">
                    Numéro de téléphone 
                    <span class="text-gray-400 text-xs">(optionnel, unique)</span>
                </label>
                <input
                    id="phone"
                    name="phone"
                ...
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-xs text-gray-500">Vous pourrez utiliser ce numéro pour vous connecter ou récupérer votre compte</p>
            </div>
        ...
        <div class="mt-6">
            ...
            <div class="mt-6 grid grid-cols-1 gap-3">
                <a href="{{ \Illuminate\Support\Facades\Route::has('login.provider') ? route('login.provider', 'google') : '#' }}" class="w-full inline-flex items-center justify-center py-3 px-4 border-2 border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-colors">
                    ...
                    <span class="font-semibold">S'inscrire avec Google</span>
                </a>
            </div>
        </div>
