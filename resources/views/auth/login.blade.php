...
{{--                    </a>--}}
        ...
        <!-- Profil Link (visible seulement si connecté) -->
        @auth
        <div class="mt-4 text-center">
            <a href="{{ route('user.profile') }}" class="inline-flex items-center gap-2 text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors">
